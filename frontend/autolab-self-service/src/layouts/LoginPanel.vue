<template>
  <q-page class="q-px-lg q-mx-auto" style="max-width: 1000px;">
    <div v-if="userStore.userDataLoading" class="absolute-center">
      <q-spinner-gears class="q-mb-lg" color="primary" size="100"/>
      <p>Loading profile</p>
    </div>
    <div v-else class="column items-center content-center">
      <h4>Welcome!</h4>
      <h5 class="q-mt-none">You need to sign in to continue</h5>
    ...
    <div v-if="userStore.developerMode">
      <q-banner class="q-my-xl bg-red-10 text-white">
